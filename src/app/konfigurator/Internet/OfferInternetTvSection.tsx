  ...
  return (
    ...
    >
      ...
      <ul className="mb-6 flex-1 list-none space-y-3 p-0">
        {plan.features.map((f: OfferFeature) => (
      ...
      <div className="overflow-x-hidden bg-[#0B2A3D] font-sans text-white sm:pt-20 pt-16">
        <div className="mx-auto max-w-[1140px] px-4 sm:px-6">
          ...
          <m.div
            ...
            variants={fadeUp}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="mt-12 mb-8 scroll-mt-[160px] text-center sm:mt-16 sm:mb-10"
          >
          ...
          <div className="relative">
            ...
            <div className="relative grid grid-cols-1 gap-6 pt-2 md:grid-cols-2">
